...
class Mail
{
    ...
    public static function send($data) 
    {
        ...
        $toEmail = (array_key_exists('toEmail', $data)) ? $data['toEmail'] : null;
        $toName = (array_key_exists('toName', $data)) ? $data['toName'] : null;
        ...
        if (array_key_exists('service', $data)) {
            ...
            $templateData = array_key_exists('templateData', $data) 
                ? $data['templateData'] 
                : array('body' => $body);

            $templateData['unsubscribe_hash'] = base64_encode($toEmail);
